...
import com.pepebot.terminal.R;
import com.pepebot.terminal.app.api.file.FileReceiverActivity;
import com.pepebot.terminal.app.terminal.TermuxActivityRootView;
import com.pepebot.terminal.app.terminal.TermuxTerminalSessionActivityClient;
import com.pepebot.terminal.app.terminal.io.TermuxTerminalExtraKeys;
...
import com.pepebot.terminal.app.activities.HelpActivity;
import com.pepebot.terminal.app.activities.SettingsActivity;
import com.termux.shared.termux.crash.TermuxCrashUtils;
import com.termux.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.pepebot.terminal.app.terminal.TermuxSessionsListViewController;
import com.pepebot.terminal.app.terminal.io.TerminalToolbarViewPager;
import com.pepebot.terminal.app.terminal.TermuxTerminalViewClient;
...
public final class TermuxActivity extends AppCompatActivity implements ServiceConnection {
        ...
        if (mTermuxService.isTermuxSessionsEmpty()) {
            if (mIsVisible) {
                TermuxInstaller.setupBootstrapIfNeeded(TermuxActivity.this, () -> {
                    ...
                    // Install pepebot binary
                    PepebotInstaller.installPepebotIfNeeded(TermuxActivity.this);
    ...
    private void setPepebotControlButtons() {
        // Configure button
        findViewById(R.id.pepebot_configure_button).setOnClickListener(v -> {
            injectCommandToTerminal("pepebot onboard\n");
            showToast("Running pepebot configuration...", false);
        });
        ...
        findViewById(R.id.pepebot_start_button).setOnClickListener(v -> {
            ...
            intent.setAction(TERMUX_SERVICE.ACTION_WAKE_LOCK);
            startService(intent);
        });

        // Stop Server button
        findViewById(R.id.pepebot_stop_button).setOnClickListener(v -> {
            TerminalSession currentSession = getCurrentSession();
            if (currentSession != null && currentSession.isRunning()) {
                currentSession.write(new byte[]{3}, 0, 1); // Ctrl+C
                showToast("Stopping server...", false);

                // Release wakelock
                Intent intent = new Intent(this, TermuxService.class);
                intent.setAction(TERMUX_SERVICE.ACTION_WAKE_UNLOCK);
                startService(intent);
            }
        });
    }
