 ...
 * This class will be hosted by termux-shared lib and should be imported by
 * other termux plugin
 * apps as is instead of copying constants to random classes. The 3rd party apps
 * can also import
 * it for interacting with termux apps. If changes are made to this file,
 * increment the version number
 * and add an entry in the Changelog section above.
 *
 * Termux app default package name is "com.termux" and is used in
 * {@link #TERMUX_PREFIX_DIR_PATH}.
 * The binaries compiled for termux have {@link #TERMUX_PREFIX_DIR_PATH}
 * hardcoded in them but it
 * can be changed during compilation.
 *
 * The {@link #TERMUX_PACKAGE_NAME} must be the same as the applicationId of
 * termux-app build.gradle
 * since its also used by {@link #TERMUX_FILES_DIR_PATH}.
 * If {@link #TERMUX_PACKAGE_NAME} is changed, then binaries, specially used in
 * bootstrap need to be
 * compiled appropriately. Check
 * https://github.com/termux/termux-packages/wiki/Building-packages
 * for more info.
 *
 * Ideally the only places where changes should be required if changing package
 * name are the following:
 * - The {@link #TERMUX_PACKAGE_NAME} in {@link TermuxConstants}.
 * - The "applicationId" in "build.gradle" of termux-app. This is package name
 * that android and app
 * stores will use and is also the final package name stored in
 * "AndroidManifest.xml".
 * - The "manifestPlaceholders" values for {@link #TERMUX_PACKAGE_NAME} and
 * *_APP_NAME in
 * "build.gradle" of termux-app.
 * - The "ENTITY" values for {@link #TERMUX_PACKAGE_NAME} and *_APP_NAME in
 * "strings.xml" of
 * termux-app and of termux-shared.
 * - The "shortcut.xml" and "*_preferences.xml" files of termux-app since
 * dynamic variables don't
 * work in it.
 * - Optionally the "package" in "AndroidManifest.xml" if modifying project
 * structure of termux-app.
 * This is package name for java classes project structure and is prefixed if
 * activity and service
 * names use dot (.) notation. This is currently not advisable since this will
 * break lot of
 * stuff, including termux-* packages.
 * - Optionally the *_PATH variables in {@link TermuxConstants} containing the
 * string "termux".
 *
 * Check https://developer.android.com/studio/build/application-id for info on
 * "package" in
 * "AndroidManifest.xml" and "applicationId" in "build.gradle".
 *
 * The {@link #TERMUX_PACKAGE_NAME} must be used in source code of Termux app
 * and its plugins instead
...
public final class TermuxConstants {
    ...
    public static final String FDROID_PACKAGES_BASE_URL = "https://f-droid.org/en/packages"; // Default:
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "Pepebot"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.terminal.pepebot"; // Default: "com.termux"
    /** Termux GitHub repo name */
    public static final String TERMUX_GITHUB_REPO_NAME = "termux-app"; // Default: "termux-app"
    /** Termux GitHub repo url */
    public static final String TERMUX_GITHUB_REPO_URL = TERMUX_GITHUB_ORGANIZATION_URL + "/" + TERMUX_GITHUB_REPO_NAME; // Default:
                                                                                                                        // "https://github.com/termux/termux-app"
    /** Termux GitHub issues repo url */
    public static final String TERMUX_GITHUB_ISSUES_REPO_URL = TERMUX_GITHUB_REPO_URL + "/issues"; // Default:
                                                                                                   // "https://github.com/termux/termux-app/issues"
    /** Termux F-Droid package url */
    public static final String TERMUX_FDROID_PACKAGE_URL = FDROID_PACKAGES_BASE_URL + "/" + TERMUX_PACKAGE_NAME; // Default:
    ...
    public static final String TERMUX_API_GITHUB_ISSUES_REPO_URL = TERMUX_API_GITHUB_REPO_URL + "/issues"; // Default:
                                                                                                           // "https://github.com/termux/termux-api/issues"
    /** Termux:API F-Droid package url */
    public static final String TERMUX_API_FDROID_PACKAGE_URL = FDROID_PACKAGES_BASE_URL + "/" + TERMUX_API_PACKAGE_NAME; // Default:
    ...
    public static final String TERMUX_BOOT_GITHUB_ISSUES_REPO_URL = TERMUX_BOOT_GITHUB_REPO_URL + "/issues"; // Default:
    ...
    public static final String TERMUX_FLOAT_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".window"; // Default:
                                                                                            // "com.termux.window"
    ...
    public static final String TERMUX_FLOAT_GITHUB_ISSUES_REPO_URL = TERMUX_FLOAT_GITHUB_REPO_URL + "/issues"; // Default:
    ...
    public static final String TERMUX_STYLING_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".styling"; // Default:
                                                                                               // "com.termux.styling"
    ...
    public static final String TERMUX_STYLING_GITHUB_ISSUES_REPO_URL = TERMUX_STYLING_GITHUB_REPO_URL + "/issues"; // Default:
                                                                                                                   // "https://github.com/termux/termux-styling/issues"
    ...
    public static final String TERMUX_TASKER_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".tasker"; // Default:
                                                                                             // "com.termux.tasker"
    ...
    public static final String TERMUX_TASKER_GITHUB_ISSUES_REPO_URL = TERMUX_TASKER_GITHUB_REPO_URL + "/issues"; // Default:
                                                                                                                 // "https://github.com/termux/termux-tasker/issues"
    ...
    public static final String TERMUX_WIDGET_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".widget"; // Default:
                                                                                             // "com.termux.widget"
    ...
    public static final String TERMUX_WIDGET_GITHUB_ISSUES_REPO_URL = TERMUX_WIDGET_GITHUB_REPO_URL + "/issues"; // Default:
                                                                                                                 // "https://github.com/termux/termux-widget/issues"
    ...
    public static final String APK_RELEASE_FDROID_SIGNING_CERTIFICATE_SHA256_DIGEST = "228FB2CFE90831C1499EC3CCAF61E96E8E1CE70766B9474672CE427334D41C42"; // Default:
    ...
    public static final String APK_RELEASE_GITHUB_SIGNING_CERTIFICATE_SHA256_DIGEST = "B6DA01480EEFD5FBF2CD3771B8D1021EC791304BDD6C4BF41D3FAABAD48EE5E1"; // Default:
    ...
    public static final String APK_RELEASE_GOOGLE_PLAYSTORE_SIGNING_CERTIFICATE_SHA256_DIGEST = "738F0A30A04D3C8A1BE304AF18D0779BCF3EA88FB60808F657A3521861C2EBF9"; // Default:
    ...
    public static final String APK_RELEASE_TERMUX_DEVS_SIGNING_CERTIFICATE_SHA256_DIGEST = "F7A038EB551F1BE8FDF388686B784ABAB4552A5D82DF423E3D8F1B5CBE1C69AE"; // Default:
    ...
    public static final String TERMUX_PACKAGES_GITHUB_ISSUES_REPO_URL = TERMUX_PACKAGES_GITHUB_REPO_URL + "/issues"; // Default:
    ...
    public static final String TERMUX_API_APT_GITHUB_ISSUES_REPO_URL = TERMUX_API_APT_GITHUB_REPO_URL + "/issues"; // Default:
                                                                                                                   // "https://github.com/termux/termux-api-package/issues"
    ...
    public static final String TERMUX_GITHUB_WIKI_REPO_URL = TERMUX_GITHUB_REPO_URL + "/wiki"; // Default:
                                                                                               // "https://github.com/termux/termux-app/wiki"

    /** Termux Packages wiki repo url */
    public static final String TERMUX_PACKAGES_GITHUB_WIKI_REPO_URL = TERMUX_PACKAGES_GITHUB_REPO_URL + "/wiki"; // Default:
    ...
    public static final String TERMUX_SUPPORT_EMAIL_MAILTO_URL = "mailto:" + TERMUX_SUPPORT_EMAIL_URL; // Default:
                                                                                                       // "mailto:support@termux.dev"
    ...
    public static final String TERMUX_REDDIT_SUBREDDIT_URL = "https://www.reddit.com/r/termux"; // Default:
    ...
    public static final String TERMUX_INTERNAL_PRIVATE_APP_DATA_DIR_PATH = "/data/data/" + TERMUX_PACKAGE_NAME; // Default:
    ...
    public static final String TERMUX_FILES_DIR_PATH = TERMUX_INTERNAL_PRIVATE_APP_DATA_DIR_PATH + "/files"; // Default:
    ...
    public static final String TERMUX_PREFIX_DIR_PATH = TERMUX_FILES_DIR_PATH + "/usr"; // Default:
    ...
    public static final String TERMUX_BIN_PREFIX_DIR_PATH = TERMUX_PREFIX_DIR_PATH + "/bin"; // Default:
    ...
    public static final String TERMUX_ETC_PREFIX_DIR_PATH = TERMUX_PREFIX_DIR_PATH + "/etc"; // Default:
    ...
    public static final String TERMUX_INCLUDE_PREFIX_DIR_PATH = TERMUX_PREFIX_DIR_PATH + "/include"; // Default:
    ...
    public static final String TERMUX_LIB_PREFIX_DIR_PATH = TERMUX_PREFIX_DIR_PATH + "/lib"; // Default:
    ...
    public static final String TERMUX_LIBEXEC_PREFIX_DIR_PATH = TERMUX_PREFIX_DIR_PATH + "/libexec"; // Default:
    ...
    public static final String TERMUX_SHARE_PREFIX_DIR_PATH = TERMUX_PREFIX_DIR_PATH + "/share"; // Default:
    ...
    public static final String TERMUX_TMP_PREFIX_DIR_PATH = TERMUX_PREFIX_DIR_PATH + "/tmp"; // Default:
    ...
    public static final String TERMUX_VAR_PREFIX_DIR_PATH = TERMUX_PREFIX_DIR_PATH + "/var"; // Default:
    ...
    public static final String TERMUX_STAGING_PREFIX_DIR_PATH = TERMUX_FILES_DIR_PATH + "/usr-staging"; // Default:
    ...
    public static final String TERMUX_HOME_DIR_PATH = TERMUX_FILES_DIR_PATH + "/home"; // Default:
    ...
    public static final String TERMUX_CONFIG_HOME_DIR_PATH = TERMUX_HOME_DIR_PATH + "/.config/termux"; // Default:
                                                                                                       // "/data/data/com.termux/files/home/.config/termux"
    ...
    public static final String TERMUX_CONFIG_PREFIX_DIR_PATH = TERMUX_ETC_PREFIX_DIR_PATH + "/termux"; // Default:
                                                                                                       // "/data/data/com.termux/files/usr/etc/termux"
    ...
    public static final String TERMUX_DATA_HOME_DIR_PATH = TERMUX_HOME_DIR_PATH + "/.termux"; // Default:
    ...
    public static final String TERMUX_STORAGE_HOME_DIR_PATH = TERMUX_HOME_DIR_PATH + "/storage"; // Default:
    ...
    public static final String TERMUX_APPS_DIR_PATH = TERMUX_FILES_DIR_PATH + "/apps"; // Default:
    ...
    public static final String TERMUX_PROPERTIES_PRIMARY_FILE_PATH = TERMUX_DATA_HOME_DIR_PATH + "/termux.properties"; // Default:
    ...
    /**
     * Termux app properties file paths list. **DO NOT** allow these files to be
     * modified by
     * {@link android.content.ContentProvider} exposed to external apps, since they
     * may silently
     * modify the values for security properties like
     * {@link #PROP_ALLOW_EXTERNAL_APPS} set by users
    ...
    public static final String TERMUX_FLOAT_PROPERTIES_SECONDARY_FILE_PATH = TERMUX_CONFIG_HOME_DIR_PATH
            + "/termux.float.properties"; // Default:
                                          // "/data/data/com.termux/files/home/.config/termux/termux.float.properties"
    ...
    /**
     * Termux:Float app properties file paths list. **DO NOT** allow these files to
     * be modified by
     * {@link android.content.ContentProvider} exposed to external apps, since they
     * may silently
     * modify the values for security properties like
    ...
    public static final String TERMUX_COLOR_PROPERTIES_FILE_PATH = TERMUX_DATA_HOME_DIR_PATH + "/colors.properties"; // Default:
    ...
    public static final String TERMUX_FONT_FILE_PATH = TERMUX_DATA_HOME_DIR_PATH + "/font.ttf"; // Default:
    ...
    public static final String TERMUX_CRASH_LOG_FILE_PATH = TERMUX_HOME_DIR_PATH + "/crash_log.md"; // Default:
                                                                                                    // "/data/data/com.termux/files/home/crash_log.md"

    /** Termux app and plugins crash log backup file path */
    public static final String TERMUX_CRASH_LOG_BACKUP_FILE_PATH = TERMUX_HOME_DIR_PATH + "/crash_log_backup.md"; // Default:
                                                                                                                  // "/data/data/com.termux/files/home/crash_log_backup.md"

    /** Termux app environment file path */
    public static final String TERMUX_ENV_FILE_PATH = TERMUX_CONFIG_PREFIX_DIR_PATH + "/termux.env"; // Default:
                                                                                                     // "/data/data/com.termux/files/usr/etc/termux/termux.env"

    /** Termux app environment temp file path */
    public static final String TERMUX_ENV_TEMP_FILE_PATH = TERMUX_CONFIG_PREFIX_DIR_PATH + "/termux.env.tmp"; // Default:
                                                                                                              // "/data/data/com.termux/files/usr/etc/termux/termux.env.tmp"
     ...
     */
    public static final String TERMUX_BOOT_SCRIPTS_DIR_PATH = TERMUX_DATA_HOME_DIR_PATH + "/boot"; // Default:
    ...
    /**
     * Termux app directory path to store foreground scripts that can be run by the
     * termux launcher
     * widget provided by Termux:Widget
     */
    public static final String TERMUX_SHORTCUT_SCRIPTS_DIR_PATH = TERMUX_HOME_DIR_PATH + "/.shortcuts"; // Default:
                                                                                                        // "/data/data/com.termux/files/home/.shortcuts"
    /**
     * Termux app directory to store foreground scripts that can be run by the
     * termux launcher widget provided by Termux:Widget
     */
    public static final File TERMUX_SHORTCUT_SCRIPTS_DIR = new File(TERMUX_SHORTCUT_SCRIPTS_DIR_PATH);

    /**
     * Termux app directory basename that stores background scripts that can be run
     * by the termux
    ...
    /**
     * Termux app directory path to store background scripts that can be run by the
     * termux launcher
     * widget provided by Termux:Widget
     */
    ...
    /**
     * Termux app directory to store background scripts that can be run by the
     * termux launcher widget provided by Termux:Widget
     */
    public static final File TERMUX_SHORTCUT_TASKS_SCRIPTS_DIR = new File(TERMUX_SHORTCUT_TASKS_SCRIPTS_DIR_PATH);

    /**
     * Termux app directory basename that stores icons for the foreground and
     * background scripts
    ...
    /**
     * Termux app directory path to store icons for the foreground and background
     * scripts that can
    ...
    /**
     * Termux app directory to store icons for the foreground and background scripts
     * that can be
    ...
    /**
     * Termux app directory path to store scripts to be run by 3rd party
     * twofortyfouram locale plugin
     * host apps like Tasker app via the Termux:Tasker plugin client
     */
    public static final String TERMUX_TASKER_SCRIPTS_DIR_PATH = TERMUX_DATA_HOME_DIR_PATH + "/tasker"; // Default:
                                                                                                       // "/data/data/com.termux/files/home/.termux/tasker"
    /**
     * Termux app directory to store scripts to be run by 3rd party twofortyfouram
     * locale plugin host apps like Tasker app via the Termux:Tasker plugin client
     */
    ...
    /**
     * Termux app notification channel name used by
     * {@link TERMUX_APP.TERMUX_SERVICE}
     */
     ...
     * {@link TERMUX_APP.RUN_COMMAND_SERVICE}
     */
    ...
    public static final String TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_NAME = TermuxConstants.TERMUX_APP_NAME
            + " RunCommandService";
    /**
     * Termux app unique notification id used by
     * {@link TERMUX_APP.RUN_COMMAND_SERVICE}
     */
    ...
    /**
     * Termux app notification channel id used by
     * {@link TERMUX_FLOAT_APP.TERMUX_FLOAT_SERVICE}
     */
    ...
    /**
     * Android OS permission declared by Termux app in AndroidManifest.xml which can
     * be requested by
     * 3rd party apps to run various commands in Termux app context
     */
    public static final String PERMISSION_RUN_COMMAND = TERMUX_PACKAGE_NAME + ".permission.RUN_COMMAND"; // Default:
                                                                                                         // "com.termux.permission.RUN_COMMAND"

    /**
     * Termux property defined in termux.properties file as a secondary check to
    ...
    public static final String TERMUX_FILE_SHARE_URI_AUTHORITY = TERMUX_PACKAGE_NAME + ".files"; // Default:
                                                                                                 // "com.termux.files"
    ...
    /**
     * The alternate comma character (U+201A, &sbquo;, &#8218;, single low-9
     * quotation mark) that
    ...
    public static final class TERMUX_APP {
        ...
        public static final String APPS_DIR_PATH = TERMUX_APPS_DIR_PATH + "/" + TERMUX_PACKAGE_NAME; // Default:
                                                                                                     // "/data/data/com.termux/files/apps/com.termux"

        /** termux-am socket file path */
        public static final String TERMUX_AM_SOCKET_FILE_PATH = APPS_DIR_PATH + "/termux-am/am.sock"; // Default:
                                                                                                      // "/data/data/com.termux/files/apps/com.termux/termux-am/am.sock"

        /** Termux app BuildConfig class name */
        public static final String BUILD_CONFIG_CLASS_NAME = TERMUX_PACKAGE_NAME + ".BuildConfig"; // Default:
                                                                                                   // "com.termux.BuildConfig"
        ...
        public static final String FILE_SHARE_RECEIVER_ACTIVITY_CLASS_NAME = TERMUX_PACKAGE_NAME
                + ".app.api.file.FileShareReceiverActivity"; // Default:
        ...
        public static final String FILE_VIEW_RECEIVER_ACTIVITY_CLASS_NAME = TERMUX_PACKAGE_NAME
                + ".app.api.file.FileViewReceiverActivity"; // Default:
                                                            // "com.termux.app.api.file.FileViewReceiverActivity"

        /** Termux app core activity name. */
        public static final String TERMUX_ACTIVITY_NAME = TERMUX_PACKAGE_NAME + ".app.TermuxActivity"; // Default:
        ...
        public static final class TERMUX_ACTIVITY {
            ...
            /**
             * Intent extra for if termux failsafe session needs to be started and is used
             * by {@link TERMUX_ACTIVITY} and {@link TERMUX_SERVICE#ACTION_STOP_SERVICE}
             */
            ...
            public static final String ACTION_RELOAD_STYLE = TermuxConstants.TERMUX_PACKAGE_NAME + ".app.reload_style"; // Default:
                                                                                                                        // "com.termux.app.reload_style"
            /**
             * Intent {@code String} extra for what to reload for the
             * TERMUX_ACTIVITY.ACTION_RELOAD_STYLE intent. This has been deperecated.
             */
            @Deprecated
            public static final String EXTRA_RELOAD_STYLE = TermuxConstants.TERMUX_PACKAGE_NAME + ".app.reload_style"; // Default:
                                                                                                                       // "com.termux.app.reload_style"

            /**
             * Intent {@code boolean} extra for whether to recreate activity for the
             * TERMUX_ACTIVITY.ACTION_RELOAD_STYLE intent.
             */
        ...
        public static final String TERMUX_SERVICE_NAME = TERMUX_PACKAGE_NAME + ".app.TermuxService"; // Default:
        ...
        public static final class TERMUX_SERVICE {
            ...
            public static final String ACTION_STOP_SERVICE = TERMUX_PACKAGE_NAME + ".service_stop"; // Default:
                                                                                                    // "com.termux.service_stop"

            /** Intent action to make TERMUX_SERVICE acquire a wakelock */
            public static final String ACTION_WAKE_LOCK = TERMUX_PACKAGE_NAME + ".service_wake_lock"; // Default:
                                                                                                      // "com.termux.service_wake_lock"

            /** Intent action to make TERMUX_SERVICE release wakelock */
            public static final String ACTION_WAKE_UNLOCK = TERMUX_PACKAGE_NAME + ".service_wake_unlock"; // Default:
                                                                                                          // "com.termux.service_wake_unlock"

            /** Intent action to execute command with TERMUX_SERVICE */
            public static final String ACTION_SERVICE_EXECUTE = TERMUX_PACKAGE_NAME + ".service_execute"; // Default:
                                                                                                          // "com.termux.service_execute"

            /** Uri scheme for paths sent via intent to TERMUX_SERVICE */
            public static final String URI_SCHEME_SERVICE_EXECUTE = TERMUX_PACKAGE_NAME + ".file"; // Default:
                                                                                                   // "com.termux.file"
            /**
             * Intent {@code String[]} extra for arguments to the executable of the command
             * for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_ARGUMENTS = TERMUX_PACKAGE_NAME + ".execute.arguments"; // Default:
                                                                                                     // "com.termux.execute.arguments"
            /**
             * Intent {@code String} extra for stdin of the command for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_STDIN = TERMUX_PACKAGE_NAME + ".execute.stdin"; // Default:
                                                                                             // "com.termux.execute.stdin"
            /**
             * Intent {@code String} extra for command current working directory for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_WORKDIR = TERMUX_PACKAGE_NAME + ".execute.cwd"; // Default:
                                                                                             // "com.termux.execute.cwd"
            /**
             * Intent {@code boolean} extra for whether to run command in background
             * {@link Runner#APP_SHELL} or foreground {@link Runner#TERMINAL_SESSION} for
             * the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            @Deprecated
            public static final String EXTRA_BACKGROUND = TERMUX_PACKAGE_NAME + ".execute.background"; // Default:
                                                                                                       // "com.termux.execute.background"
            /**
             * Intent {@code String} extra for command the {@link Runner} for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_RUNNER = TERMUX_PACKAGE_NAME + ".execute.runner"; // Default:
                                                                                               // "com.termux.execute.runner"
            /**
             * Intent {@code String} extra for custom log level for background commands
             * defined by {@link com.termux.shared.logger.Logger} for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_BACKGROUND_CUSTOM_LOG_LEVEL = TERMUX_PACKAGE_NAME
                    + ".execute.background_custom_log_level"; // Default:
                                                              // "com.termux.execute.background_custom_log_level"
            /**
             * Intent {@code String} extra for session action for
             * {@link Runner#TERMINAL_SESSION} commands for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_SESSION_ACTION = TERMUX_PACKAGE_NAME + ".execute.session_action"; // Default:
                                                                                                               // "com.termux.execute.session_action"
            /**
             * Intent {@code String} extra for shell name for commands for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_SHELL_NAME = TERMUX_PACKAGE_NAME + ".execute.shell_name"; // Default:
                                                                                                       // "com.termux.execute.shell_name"
            /**
             * Intent {@code String} extra for the {@link ExecutionCommand.ShellCreateMode}
             * for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent.
             */
            public static final String EXTRA_SHELL_CREATE_MODE = TERMUX_PACKAGE_NAME + ".execute.shell_create_mode"; // Default:
                                                                                                                     // "com.termux.execute.shell_create_mode"
            /**
             * Intent {@code String} extra for label of the command for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_COMMAND_LABEL = TERMUX_PACKAGE_NAME + ".execute.command_label"; // Default:
                                                                                                             // "com.termux.execute.command_label"
            /**
             * Intent markdown {@code String} extra for description of the command for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_COMMAND_DESCRIPTION = TERMUX_PACKAGE_NAME + ".execute.command_description"; // Default:
                                                                                                                         // "com.termux.execute.command_description"
            /**
             * Intent markdown {@code String} extra for help of the command for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_COMMAND_HELP = TERMUX_PACKAGE_NAME + ".execute.command_help"; // Default:
                                                                                                           // "com.termux.execute.command_help"
            /**
             * Intent markdown {@code String} extra for help of the plugin API for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent (Internal Use Only)
             */
            public static final String EXTRA_PLUGIN_API_HELP = TERMUX_PACKAGE_NAME + ".execute.plugin_api_help"; // Default:
                                                                                                                 // "com.termux.execute.plugin_help"
            /**
             * Intent {@code Parcelable} extra for the pending intent that should be sent
             * with the
             * result of the execution command to the execute command caller for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_PENDING_INTENT = "pendingIntent"; // Default: "pendingIntent"
            /**
             * Intent {@code String} extra for the directory path in which to write the
             * result of the
             * execution command for the execute command caller for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_RESULT_DIRECTORY = TERMUX_PACKAGE_NAME + ".execute.result_directory"; // Default:
                                                                                                                   // "com.termux.execute.result_directory"
            /**
             * Intent {@code boolean} extra for whether the result should be written to a
             * single file
             * or multiple files (err, errmsg, stdout, stderr, exit_code) in
             * {@link #EXTRA_RESULT_DIRECTORY} for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE
             * intent
             */
            public static final String EXTRA_RESULT_SINGLE_FILE = TERMUX_PACKAGE_NAME + ".execute.result_single_file"; // Default:
                                                                                                                       // "com.termux.execute.result_single_file"
            /**
             * Intent {@code String} extra for the basename of the result file that should
             * be created
             * in {@link #EXTRA_RESULT_DIRECTORY} if {@link #EXTRA_RESULT_SINGLE_FILE} is
             * {@code true}
             * for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
             ...
             * {@link #EXTRA_RESULT_FILE_BASENAME} result file for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            ...
            /**
             * Intent {@code String} extra for the optional suffix of the result files that
             * should
             * be created in {@link #EXTRA_RESULT_DIRECTORY} if
             * {@link #EXTRA_RESULT_SINGLE_FILE} is
             * {@code false} for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
             */
            public static final String EXTRA_RESULT_FILES_SUFFIX = TERMUX_PACKAGE_NAME + ".execute.result_files_suffix"; // Default:
                                                                                                                         // "com.termux.execute.result_files_suffix"

            /**
             * The value for {@link #EXTRA_SESSION_ACTION} extra that will set the new
             * session as
             * the current session and will start {@link TERMUX_ACTIVITY} if its not running
             * to bring
            ...
            /**
             * The value for {@link #EXTRA_SESSION_ACTION} extra that will keep any existing
             * session
             * as the current session and will start {@link TERMUX_ACTIVITY} if its not
             * running to
             * bring the existing session to foreground. The new session will be added to
             * the left
             ...
             * The value for {@link #EXTRA_SESSION_ACTION} extra that will set the new
             * session as
             * the current session but will not start {@link TERMUX_ACTIVITY} if its not
             * running
             * and session(s) will be seen in Termux notification and can be clicked to
             * bring new
             * session to foreground. If the {@link TERMUX_ACTIVITY} is already running,
             * then this
             * will behave like
             * {@link #VALUE_EXTRA_SESSION_ACTION_KEEP_CURRENT_SESSION_AND_OPEN_ACTIVITY}.
             */
             ...
             * The value for {@link #EXTRA_SESSION_ACTION} extra that will keep any existing
             * session
             * as the current session but will not start {@link TERMUX_ACTIVITY} if its not
             * running
             * and session(s) will be seen in Termux notification and can be clicked to
             * bring
             * existing session to foreground. If the {@link TERMUX_ACTIVITY} is already
             * running,
             * then this will behave like
             * {@link #VALUE_EXTRA_SESSION_ACTION_KEEP_CURRENT_SESSION_AND_OPEN_ACTIVITY}.
             */
            ...
            /**
             * Intent {@code Bundle} extra to store result of execute command that is sent
             * back for the
             * TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent if the
             * {@link #EXTRA_PENDING_INTENT} is not
             * {@code null}
             */
            public static final String EXTRA_PLUGIN_RESULT_BUNDLE = "result"; // Default: "result"
            /**
             * Intent {@code String} extra for stdout value of execute command of the
             * {@link #EXTRA_PLUGIN_RESULT_BUNDLE}
             */
            public static final String EXTRA_PLUGIN_RESULT_BUNDLE_STDOUT = "stdout"; // Default: "stdout"
            /**
             * Intent {@code String} extra for original length of stdout value of execute
             * command of the {@link #EXTRA_PLUGIN_RESULT_BUNDLE}
             */
            public static final String EXTRA_PLUGIN_RESULT_BUNDLE_STDOUT_ORIGINAL_LENGTH = "stdout_original_length"; // Default:
                                                                                                                     // "stdout_original_length"
            /**
             * Intent {@code String} extra for stderr value of execute command of the
             * {@link #EXTRA_PLUGIN_RESULT_BUNDLE}
             */
            public static final String EXTRA_PLUGIN_RESULT_BUNDLE_STDERR = "stderr"; // Default: "stderr"
            /**
             * Intent {@code String} extra for original length of stderr value of execute
             * command of the {@link #EXTRA_PLUGIN_RESULT_BUNDLE}
             */
            public static final String EXTRA_PLUGIN_RESULT_BUNDLE_STDERR_ORIGINAL_LENGTH = "stderr_original_length"; // Default:
                                                                                                                     // "stderr_original_length"
            /**
             * Intent {@code int} extra for exit code value of execute command of the
             * {@link #EXTRA_PLUGIN_RESULT_BUNDLE}
             */
            public static final String EXTRA_PLUGIN_RESULT_BUNDLE_EXIT_CODE = "exitCode"; // Default: "exitCode"
            /**
             * Intent {@code int} extra for err value of execute command of the
             * {@link #EXTRA_PLUGIN_RESULT_BUNDLE}
             */
            public static final String EXTRA_PLUGIN_RESULT_BUNDLE_ERR = "err"; // Default: "err"
            /**
             * Intent {@code String} extra for errmsg value of execute command of the
             * {@link #EXTRA_PLUGIN_RESULT_BUNDLE}
             */
        ...
        public static final String RUN_COMMAND_SERVICE_NAME = TERMUX_PACKAGE_NAME + ".app.RunCommandService"; // Termux
                                                                                                              // app
                                                                                                              // service
                                                                                                              // to
                                                                                                              // receive
        ...
        public static final class RUN_COMMAND_SERVICE {
            ...
            public static final String RUN_COMMAND_API_HELP_URL = TERMUX_GITHUB_WIKI_REPO_URL + "/RUN_COMMAND-Intent"; // Default:
                                                                                                                       // "https://github.com/termux/termux-app/wiki/RUN_COMMAND-Intent"

            /** Intent action to execute command with RUN_COMMAND_SERVICE */
            public static final String ACTION_RUN_COMMAND = TERMUX_PACKAGE_NAME + ".RUN_COMMAND"; // Default:
                                                                                                  // "com.termux.RUN_COMMAND"

            /**
             * Intent {@code String} extra for absolute path of command for the
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_COMMAND_PATH = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_PATH"; // Default:
                                                                                                       // "com.termux.RUN_COMMAND_PATH"
            /**
             * Intent {@code String[]} extra for arguments to the executable of the command
             * for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_ARGUMENTS = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_ARGUMENTS"; // Default:
                                                                                                         // "com.termux.RUN_COMMAND_ARGUMENTS"
            /**
             * Intent {@code boolean} extra for whether to replace comma alternative
             * characters in arguments with comma characters for the
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            ...
            /**
             * Intent {@code String} extra for the comma alternative characters in arguments
             * that should be replaced instead of the default {@link #COMMA_ALTERNATIVE} for
             * the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_COMMA_ALTERNATIVE_CHARS_IN_ARGUMENTS = TERMUX_PACKAGE_NAME
                    + ".RUN_COMMAND_COMMA_ALTERNATIVE_CHARS_IN_ARGUMENTS"; // Default:
             ...
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_STDIN = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_STDIN"; // Default:
                                                                                                 // "com.termux.RUN_COMMAND_STDIN"
            /**
             * Intent {@code String} extra for current working directory of command for the
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_WORKDIR = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_WORKDIR"; // Default:
             ...
             */
            @Deprecated
            public static final String EXTRA_BACKGROUND = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_BACKGROUND"; // Default:
                                                                                                           // "com.termux.RUN_COMMAND_BACKGROUND"
            /**
             * Intent {@code String} extra for command the {@link Runner} for the
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_RUNNER = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_RUNNER"; // Default:
             ...
             */
            public static final String EXTRA_BACKGROUND_CUSTOM_LOG_LEVEL = TERMUX_PACKAGE_NAME
                    + ".RUN_COMMAND_BACKGROUND_CUSTOM_LOG_LEVEL"; // Default:
             ...
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_SESSION_ACTION = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_SESSION_ACTION"; // Default:
                                                                                                                   // "com.termux.RUN_COMMAND_SESSION_ACTION"
            /**
             * Intent {@code String} extra for shell name of commands for the
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_SHELL_NAME = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_SHELL_NAME"; // Default:
                                                                                                           // "com.termux.RUN_COMMAND_SHELL_NAME"
            /**
             * Intent {@code String} extra for the {@link ExecutionCommand.ShellCreateMode}
             * for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent.
             */
            public static final String EXTRA_SHELL_CREATE_MODE = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_SHELL_CREATE_MODE"; // Default:
                                                                                                                         // "com.termux.RUN_COMMAND_SHELL_CREATE_MODE"
            /**
             * Intent {@code String} extra for label of the command for the
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_COMMAND_LABEL = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_COMMAND_LABEL"; // Default:
             ...
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_COMMAND_HELP = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_COMMAND_HELP"; // Default:
                                                                                                               // "com.termux.RUN_COMMAND_COMMAND_HELP"
            /**
             * Intent {@code Parcelable} extra for the pending intent that should be sent
             * with the result of the execution command to the execute command caller for
             * the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_PENDING_INTENT = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_PENDING_INTENT"; // Default:
                                                                                                                   // "com.termux.RUN_COMMAND_PENDING_INTENT"
            /**
             * Intent {@code String} extra for the directory path in which to write the
             * result of
             * the execution command for the execute command caller for the
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
            public static final String EXTRA_RESULT_DIRECTORY = TERMUX_PACKAGE_NAME + ".RUN_COMMAND_RESULT_DIRECTORY"; // Default:
                                                                                                                       // "com.termux.RUN_COMMAND_RESULT_DIRECTORY"
            /**
             * Intent {@code boolean} extra for whether the result should be written to a
             * single file
             * or multiple files (err, errmsg, stdout, stderr, exit_code) in
             * {@link #EXTRA_RESULT_DIRECTORY} for the
             * RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
             */
             ...
             */
            public static final String EXTRA_RESULT_FILE_OUTPUT_FORMAT = TERMUX_PACKAGE_NAME
                    + ".RUN_COMMAND_RESULT_FILE_OUTPUT_FORMAT"; // Default:
             ...
             */
            public static final String EXTRA_RESULT_FILE_ERROR_FORMAT = TERMUX_PACKAGE_NAME
                    + ".RUN_COMMAND_RESULT_FILE_ERROR_FORMAT"; // Default:
                                                               // "com.termux.RUN_COMMAND_RESULT_FILE_ERROR_FORMAT"
            /**
             * Intent {@code String} extra for the optional suffix of the result files that
             * should be
             * created in {@link #EXTRA_RESULT_DIRECTORY} if
             * {@link #EXTRA_RESULT_SINGLE_FILE} is
    ...
    public static final class TERMUX_API_APP {
        ...
        /**
         * Termux:API app launcher activity name. This is an `activity-alias` for
         * {@link #TERMUX_API_MAIN_ACTIVITY_NAME} used for launchers with
         * {@link Intent#CATEGORY_LAUNCHER}.
         */
        public static final String TERMUX_API_LAUNCHER_ACTIVITY_NAME = TERMUX_API_PACKAGE_NAME
                + ".activities.TermuxAPILauncherActivity"; // Default:
                                                           // "com.termux.api.activities.TermuxAPILauncherActivity"
    ...
    public static final class TERMUX_BOOT_APP {
        ...
        /**
         * Termux:Boot app launcher activity name. This is an `activity-alias` for
         * {@link #TERMUX_BOOT_MAIN_ACTIVITY_NAME} used for launchers with
         * {@link Intent#CATEGORY_LAUNCHER}.
         */
        public static final String TERMUX_BOOT_LAUNCHER_ACTIVITY_NAME = TERMUX_BOOT_PACKAGE_NAME
                + ".activities.TermuxBootLauncherActivity"; // Default:
                                                            // "com.termux.boot.activities.TermuxBootLauncherActivity"
    ...
    public static final class TERMUX_FLOAT_APP {
        ...
        public static final String TERMUX_FLOAT_ACTIVITY_NAME = TERMUX_FLOAT_PACKAGE_NAME + ".TermuxFloatActivity"; // Default:
                                                                                                                    // "com.termux.window.TermuxFloatActivity"

        /** Termux:Float app core service name. */
        public static final String TERMUX_FLOAT_SERVICE_NAME = TERMUX_FLOAT_PACKAGE_NAME + ".TermuxFloatService"; // Default:
                                                                                                                  // "com.termux.window.TermuxFloatService"
        ...
        public static final class TERMUX_FLOAT_SERVICE {
            ...
            public static final String ACTION_STOP_SERVICE = TERMUX_FLOAT_PACKAGE_NAME + ".ACTION_STOP_SERVICE"; // Default:
                                                                                                                 // "com.termux.float.ACTION_STOP_SERVICE"

            /** Intent action to show float window. */
            public static final String ACTION_SHOW = TERMUX_FLOAT_PACKAGE_NAME + ".ACTION_SHOW"; // Default:
                                                                                                 // "com.termux.float.ACTION_SHOW"

            /** Intent action to hide float window. */
            public static final String ACTION_HIDE = TERMUX_FLOAT_PACKAGE_NAME + ".ACTION_HIDE"; // Default:
                                                                                                 // "com.termux.float.ACTION_HIDE"
    ...
    public static final class TERMUX_STYLING_APP {
        ...
        public static final String TERMUX_STYLING_ACTIVITY_NAME = TERMUX_STYLING_PACKAGE_NAME + ".TermuxStyleActivity"; // Default:
        ...
        public static final String TERMUX_STYLING_MAIN_ACTIVITY_NAME = TERMUX_STYLING_PACKAGE_NAME
                + ".activities.TermuxStylingMainActivity"; // Default:
                                                           // "com.termux.styling.activities.TermuxStylingMainActivity"

        /**
         * Termux:Styling app launcher activity name. This is an `activity-alias` for
         * {@link #TERMUX_STYLING_MAIN_ACTIVITY_NAME} used for launchers with
         * {@link Intent#CATEGORY_LAUNCHER}.
         */
        public static final String TERMUX_STYLING_LAUNCHER_ACTIVITY_NAME = TERMUX_STYLING_PACKAGE_NAME
                + ".activities.TermuxStylingLauncherActivity"; // Default:
                                                               // "com.termux.styling.activities.TermuxStylingLauncherActivity"
    ...
    public static final class TERMUX_TASKER_APP {
        ...
        public static final String TERMUX_TASKER_MAIN_ACTIVITY_NAME = TERMUX_TASKER_PACKAGE_NAME
                + ".activities.TermuxTaskerMainActivity"; // Default:
                                                          // "com.termux.tasker.activities.TermuxTaskerMainActivity"

        /**
         * Termux:Tasker app launcher activity name. This is an `activity-alias` for
         * {@link #TERMUX_TASKER_MAIN_ACTIVITY_NAME} used for launchers with
         * {@link Intent#CATEGORY_LAUNCHER}.
         */
        public static final String TERMUX_TASKER_LAUNCHER_ACTIVITY_NAME = TERMUX_TASKER_PACKAGE_NAME
                + ".activities.TermuxTaskerLauncherActivity"; // Default:
                                                              // "com.termux.tasker.activities.TermuxTaskerLauncherActivity"
    ...
    public static final class TERMUX_WIDGET_APP {
        ...
        public static final String TERMUX_WIDGET_MAIN_ACTIVITY_NAME = TERMUX_WIDGET_PACKAGE_NAME
                + ".activities.TermuxWidgetMainActivity"; // Default:
                                                          // "com.termux.widget.activities.TermuxWidgetMainActivity"

        /**
         * Termux:Widget app launcher activity name. This is an `activity-alias` for
         * {@link #TERMUX_WIDGET_MAIN_ACTIVITY_NAME} used for launchers with
         * {@link Intent#CATEGORY_LAUNCHER}.
         */
        public static final String TERMUX_WIDGET_LAUNCHER_ACTIVITY_NAME = TERMUX_WIDGET_PACKAGE_NAME
                + ".activities.TermuxWidgetLauncherActivity"; // Default:
                                                              // "com.termux.widget.activities.TermuxWidgetLauncherActivity"

        /**
         * Intent {@code String} extra for the token of the Termux:Widget app shortcuts.
         */
        public static final String EXTRA_TOKEN_NAME = TERMUX_PACKAGE_NAME + ".shortcut.token"; // Default:
                                                                                               // "com.termux.shortcut.token"
        ...
        public static final class TERMUX_WIDGET_PROVIDER {
            ...
            public static final String ACTION_REFRESH_WIDGET = TERMUX_WIDGET_PACKAGE_NAME + ".ACTION_REFRESH_WIDGET"; // Default:
                                                                                                                      // "com.termux.widget.ACTION_REFRESH_WIDGET"

            /**
             * Intent {@code String} extra for the file clicked for the
             * TERMUX_WIDGET_PROVIDER.ACTION_WIDGET_ITEM_CLICKED intent.
             */
            public static final String EXTRA_FILE_CLICKED = TERMUX_WIDGET_PACKAGE_NAME + ".EXTRA_FILE_CLICKED"; // Default:
                                                                                                                // "com.termux.widget.EXTRA_FILE_CLICKED"
